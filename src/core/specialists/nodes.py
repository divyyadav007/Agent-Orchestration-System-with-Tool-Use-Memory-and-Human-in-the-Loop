...
def specialist_node(state: WorkflowState, specialist: SpecialistBase) -> Dict[str, Any]:
    ...
    previous_outputs = {dep_id: completed[dep_id]["output"] for dep_id in current_subtask.dependencies if dep_id in completed}
    ...
    return {"current_task_output": result, "messages": [{"role": "assistant", "content": result}], **feedback_return}
